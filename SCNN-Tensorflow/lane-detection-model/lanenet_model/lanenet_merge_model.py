...
from encoder_decoder_model import mobilev1_encoder
from encoder_decoder_model import mobilev2_encoder
from encoder_decoder_model import shufflev1_encoder
from encoder_decoder_model import shufflev2_encoder
...
class LaneNet(cnn_basenet.CNNBaseModel):
    ...
    def __init__(self, phase, net_flag='vgg'):
        ...
        elif self._net_flag == 'mobilev1':
            self._encoder = mobilev1_encoder.MOBILENETV1Encoder(phase=phase)
        elif self._net_flag == 'mobilev2':
            self._encoder = mobilev2_encoder.MOBILENETV2Encoder(phase=phase)
        elif self._net_flag == 'shufflev1':
            self._encoder = shufflev1_encoder.SHUFFLENETV1Encoder(phase=phase)
        elif self._net_flag == 'shufflev2':
            self._encoder = shufflev2_encoder.SHUFFLENETV2Encoder(phase=phase)
        return
